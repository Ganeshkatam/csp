...
export const educationContactsData = {
    ...
    contacts: [
        ...
        {
            id: "school-education-helpline",
            title: "AP School Education Grievance Helpline",
            titleTe: "ఆంధ్రప్రదేశ్ పాఠశాల విద్యా ఫిర్యాదుల హెల్ప్‌లైన్",
            role: "Statewide Toll-Free Student, Parent & Teacher Support Helpline",
            roleTe: "రాష్ట్రవ్యాప్త ఉచిత విద్యార్థి, తల్లిదండ్రులు మరియు ఉపాధ్యాయ సహాయ కేంద్రం",
            phone: "14417",
            availability: "24x7 Toll-Free Support",
            availabilityTe: "24 గంటల ఉచిత సేవ",
            address: "Department of School Education, Andhra Pradesh",
            addressTe: "పాఠశాల విద్యా శాఖ, ఆంధ్రప్రదేశ్",
            source: "Department of School Education AP Official Portal",
            verified_on: "September 2026",
            status: "published",
            jurisdiction: "Statewide / Andhra Pradesh"
        },
        {
            id: "childline-1098",
            title: "National Childline Helpline",
            titleTe: "జాతీయ చైల్డ్‌లైన్ అత్యవసర హెల్ప్‌లైన్",
            role: "24x7 Emergency Child Protection, Welfare & Rescue Dispatch",
            roleTe: "24 గంటల ఉచిత అత్యవసర బాలల రక్షణ మరియు సంరక్షణ సేవ",
            phone: "1098",
            availability: "24x7 Continuous Emergency Dispatch",
            availabilityTe: "24 గంటల నిరంతర అత్యవసర సేవ",
            address: "Ministry of Women & Child Development, Government of India",
            addressTe: "మహిళా మరియు శిశు సంక్షేమ మంత్రిత్వ శాఖ, భారత ప్రభుత్వం",
            source: "National Childline Official Portal",
            verified_on: "September 2026",
            status: "published",
            jurisdiction: "National 24x7"
        }
    ]
};

export default educationContactsData;
